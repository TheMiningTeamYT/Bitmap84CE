...
int main() {
    ...
    gfx_SetTextBGColor(0);
    gfx_FillScreen(0);
    printStringCentered("Welcome to PicView!", 0);
    ...
    printStringAndMoveDownCentered("Press up/down to scroll up/down");
    printStringAndMoveDownCentered("the list of files.");
    printStringAndMoveDownCentered("Press enter to enter a folder or");
    printStringAndMoveDownCentered("display an image.");
    printStringAndMoveDownCentered("To back out of a folder, enter the");
    printStringAndMoveDownCentered("folder called \"..\".");
    ...
    printStringAndMoveDownCentered("are supported.)");
    gfx_SwapDraw();
    while (!os_GetCSC());
    if (!init_USB()) {
        gfx_BlitScreen();
    ...
    gfx_SetTextBGColor(0);
    gfx_FillScreen(0);
    printStringCentered("You may now remove your USB drive.", 0);
    gfx_SwapDraw();
    close_USB();
    gfx_End();
}